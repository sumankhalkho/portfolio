...
const Form = () => {
  ...
  return (
    ...
    <form  action="" onSubmit={handleSubmit(getData)} >
            ...
            <input type="number" {...register("Phone",{required:"plz enter phone! ",minLength:{value:10,message:"mini 10 digits required!"},maxLength:{value:10,message:"max 10 digits required!"}})}className='form-control border-0 border-bottom rounded-0 border-danger'style={{background:'none'}} placeholder='enter number '/>
